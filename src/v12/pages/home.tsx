...
const V115_COPY = {
  ru: {
    ...
    techSubtitle: "Kaspi, iiko, 1C, WhatsApp, Telegram, таблицы, оплата, аналитика и AI. Берём только то, что реально нужно проекту, без лишнего стека ради стека.",
    launchKicker: "не просто сайт",
    launchTitle: "Лендинг - только начало. Важно, что происходит после клика.",
    launchSubtitle: "Помогаем упаковать предложение, собрать страницу, принять заявку и не потерять клиента после первого сообщения. Поэтому DosCode не про дешёвые шаблонные страницы.",
    launchCards: [
      { chip: "01", title: "Предложение", text: "Формулируем, что человек получает и почему ему стоит оставить заявку сейчас." },
      { chip: "02", title: "Страница", text: "Собираем быстрый адаптивный сайт под рекламу, прямую ссылку или запуск новой услуги." },
      { chip: "03", title: "Заявка", text: "Подключаем Telegram, WhatsApp, форму, оплату или другой простой вход для клиента." },
      { chip: "04", title: "Дальше", text: "Если предложение работает, усиливаем его ботом, дашбордом, CRM, e-commerce или MVP." },
    ],
