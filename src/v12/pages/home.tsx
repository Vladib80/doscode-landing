...
const V115_COPY = {
  ru: {
    ...
    heroTitle: "Сайты, MVP и автоматизация для заявок и продаж.",
    heroAccent: "Первый макет — через 4 часа. Смета — за день.",
    heroSubtitle:
      "Алматы, с 2020. Собираем понятный путь от оффера до заявки: лендинг, Telegram или WhatsApp, оплата, аналитика, бот, дашборд или MVP с пользователями.",
    heroCta: "Получить оценку за день",
    techKicker: "то, чем вы уже пользуетесь",
    techTitle: "Подключаемся к реальному рабочему процессу",
    techSubtitle: "Kaspi, iiko, 1C, WhatsApp, Telegram, таблицы, оплата, аналитика и AI только там, где он снимает ручную работу. Стек выбираем под результат, сроки и поддержку.",
    launchKicker: "не просто сайт",
    launchTitle: "Лендинг — не финал. Важно, что происходит после клика.",
    launchSubtitle: "Упаковываем предложение, собираем страницу, подключаем заявку и фиксируем следующий шаг для клиента. Поэтому DosCode — не про дешёвую страницу ради страницы.",
    launchCards: [
      { chip: "01", title: "Оффер", text: "Формулируем, что человек получает, кому это подходит и почему стоит оставить заявку сейчас." },
      { chip: "02", title: "Страница", text: "Собираем быстрый адаптивный сайт под рекламу, прямую ссылку, запуск услуги или проверку спроса." },
      { chip: "03", title: "Заявка", text: "Подключаем Telegram, WhatsApp, форму, оплату или другой понятный вход для клиента." },
      { chip: "04", title: "Развитие", text: "Если оффер работает, усиливаем его ботом, дашбордом, CRM, e-commerce или MVP." },
    ],
  ...
  kk: {
    ...
    heroTitle: "Өтінім мен сатылымға арналған сайт, MVP және автоматизация.",
    heroAccent: "Алғашқы макет — 4 сағатта. Смета — 1 күнде.",
    heroSubtitle:
      "Алматы, 2020 жылдан. Офферден өтінімге дейінгі түсінікті жол құрамыз: лендинг, Telegram немесе WhatsApp, төлем, аналитика, бот, дашборд немесе нақты MVP.",
    heroCta: "24 сағатта бағалау алу",
    techKicker: "бизнес қазір қолданатын интеграциялар",
    techTitle: "Нақты жұмыс процесіне қосыламыз",
    techSubtitle: "Kaspi, iiko, 1C, WhatsApp, Telegram, кестелер, төлем, аналитика және AI — тек қол жұмысты азайтатын жерде. Стекті нәтиже, мерзім және қолдау бойынша таңдаймыз.",
    launchKicker: "бет емес, іске қосу",
    launchTitle: "Лендинг — финал емес. Клиенттің кликтен кейінгі жолы маңызды.",
    launchSubtitle: "Офферді нақтылап, бетті жинап, өтінімді қосып, клиентке келесі қадамды түсінікті етеміз. Сондықтан DosCode жай арзан шаблон беттері туралы емес.",
    launchCards: [
      { chip: "01", title: "Оффер", text: "Адам не алады, бұл кімге керек және неге дәл қазір өтінім қалдыруы керек екенін нақтылаймыз." },
      { chip: "02", title: "Бет", text: "Жарнамаға, тікелей сілтемеге, жаңа қызметке немесе сұранысты тексеруге дайын адаптивті сайт жинаймыз." },
      { chip: "03", title: "Өтінім", text: "Telegram, WhatsApp, форма, төлем немесе клиентке түсінікті басқа кіру нүктесін қосамыз." },
      { chip: "04", title: "Даму", text: "Оффер жұмыс істесе, оны бот, дашборд, CRM, e-commerce немесе MVP арқылы күшейтеміз." },
    ],
  ...
  en: {
    ...
    heroTitle: "Websites, MVPs and automation for leads and sales.",
    heroAccent: "First mockup in 4 hours. Estimate in a day.",
    heroSubtitle:
      "Almaty, since 2020. We build the path from offer to lead: landing page, Telegram or WhatsApp, payments, analytics, bots, dashboards, or an MVP with real users.",
    heroCta: "Get an estimate in a day",
    techKicker: "integrations the business already uses",
    techTitle: "We connect to the real workflow",
    techSubtitle: "Kaspi, iiko, 1C, WhatsApp, Telegram, spreadsheets, payments, analytics and AI only where it removes manual work. The stack follows the outcome, timeline and support needs.",
    launchKicker: "not just a site",
    launchTitle: "The landing page is not the finish line. The post-click path matters.",
    launchSubtitle: "We shape the offer, build the page, connect lead capture and make the next step clear for the customer. DosCode is not a cheap page-for-page service.",
    launchCards: [
      { chip: "01", title: "Offer", text: "We clarify what the customer gets, who it is for and why they should leave a request now." },
      { chip: "02", title: "Page", text: "We build a fast responsive site for ads, direct links, service launches or demand validation." },
      { chip: "03", title: "Lead", text: "We connect Telegram, WhatsApp, a form, payment or another clear entry point." },
      { chip: "04", title: "Growth", text: "If the offer works, we strengthen it with a bot, dashboard, CRM, e-commerce or MVP." },
    ],
    ...
    cards: [
      {
        ...
        time: "2-8 дней",
        for: "Страница, предложение, заявки, базовая аналитика и запуск под рекламу или прямую ссылку",
        features: ["100 000 ₸ - быстрый запуск по нашей структуре", "180 000 ₸+ - лендинг + предложение + заявка + аналитика", "Форма, Telegram или WhatsApp как вход для клиента"],
      },
      {
        name: "Бизнес-продукт",
...
function RestoPulseMockup({ copy }: { copy: RestoPulseCopy }) {
  return (
    <div className="restopulse-mockup relative w-full max-w-[460px] justify-self-center overflow-hidden rounded-[2rem] border border-border/60 bg-card/40 p-3 shadow-2xl lg:justify-self-end">
        ...
        <div className="container relative z-10 mx-auto px-6">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <h1 className="max-w-4xl font-display text-4xl font-bold leading-[0.98] tracking-tighter sm:text-6xl lg:text-7xl">
